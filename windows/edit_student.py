...
notebook_frame = Frame(edit_student, bg='#2A2A3D')
...
portrait_notebook.grid(row=0, column=1, sticky=N+W)
...
save_button = button.Button_(button_container_frame, 0, 1)
...
save_button.settings(text='Save', label_bg=label_bg, hover_bg=hover_bg)
