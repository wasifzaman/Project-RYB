...
''' root window '''
edit_student = Tk()
edit_student.option_add('*Label.Font', 'Helvetica 11 italic')
edit_student.option_add('*Entry.Font', 'Helvetica 11')

''' frame initialization '''
search_frame = Frame(edit_student)
student_info_frame_1 = Frame(edit_student)
student_info_frame_2 = Frame(edit_student)
attendance_table_frame = Frame(edit_student)
...
test_opt = optionmenu.Optionmenu(attendance_table_frame, 2, 0)
test_opt.settings(add_option=['Barcode', 'First Name', 'Last Name'], set_option='Barcode', font='Helvetica 11')
