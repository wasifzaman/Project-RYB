...
attendance_notebook.grid(row=1, column=1, sticky=NW+S+E, columnspan=2, rowspan=3)
message_notebook.grid(row=0, column=2, sticky=NW+E+S)
...
dob = date_textbox.Date_textbox(general, 3, 0)
...
class_time = textbox.Textbox(payment, 13, 0)
...
parent_name = textbox.Textbox(contact, 5, 0)
...
attendance_table.settings(sheet_limit=1)
attendance_table.settings(add_row=['a', 'b', 'c'], font='Georgia 15')
attendance_table.settings(add_row=['d', 'e', 'f'], font='Georgia 15')
attendance_table.settings(add_row=['1', '2', '3'], font='Georgia 15')
#attendance_notebook.config(width=500)
#message_notebook.config(width=360)
