...
import_from_xlsx = button.Button_(import_export, 0, 0)
...
change_db = button.Button_(database, 2, 1)
...
import_from_xlsx.settings(text='Import Student Info', label_bg=label_bg, hover_bg=hover_bg)
...
change_db.settings(text='Change Database', label_bg=label_bg, hover_bg=hover_bg)
...
create_new_db.settings(text='Create SQL Database', label_bg=label_bg, hover_bg=hover_bg)
...
import_from_xlsx.label.config(width=30)
change_db.label.config(width=30)
...
import_from_xlsx.widget_frame.grid(pady=(0, 1))
